...
* See the [November 4th](https://youtu.be/AsxEmbIYUBg) meetup for more information on the data project including an example presentation. [Click here](https://fall2020.data606.net/slides/Data_Project.html) for the slides.
...
**[Click here to sign-up for a presentation time](https://docs.google.com/spreadsheets/d/1LeIT87c7iTOGmJvZ4z8eyOOP530h3LLYBCJjxAxThLY/edit#gid=0)**.

**[Peer feedback form](https://forms.gle/wc8WzVVifqwEVyPu7)**
